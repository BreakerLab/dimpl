...
t_motif_matches = Table(
    ...
    Column('motif_acc', ForeignKey('motif_old.motif_acc', ondelete='CASCADE', onupdate='CASCADE'), nullable=False, index=True),
    Column('rfam_acc', ForeignKey('family.rfam_acc', ondelete='CASCADE', onupdate='CASCADE'), nullable=False, index=True),
    Column('rfamseq_acc', ForeignKey('rfamseq.rfamseq_acc', ondelete='CASCADE', onupdate='CASCADE'), nullable=False, index=True),
...
t_secondary_structure_image = Table(
    'secondary_structure_image', metadata,
    Column('rfam_acc', ForeignKey('family.rfam_acc', ondelete='CASCADE'), nullable=False, index=True),
    Column('type', Enum('cons', 'dist', 'ent', 'fcbp', 'cov', 'disttruc', 'maxcm', 'norm', 'rchie', 'species', 'ss', 'rscape', 'rscape-cyk'), index=True),
    Column('image', LONGBLOB)
)
