...
def genome_svm_selection(
    annotated_df, class_weight_mod=0.5, c_exp=3, gamma_exp=-2, output_fasta=False, output_prefix=""
):
    ...
    if output_fasta:
        ...
        outputfilename = "data/interim/{}_selection_{}_{}_{}.fasta".format(
            output_prefix, class_weight_mod, c_exp, gamma_exp
        )
